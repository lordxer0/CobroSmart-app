...
<html lang="en" class="dark" id="html">
  ...
  <body>
    ...
    <div class="sidebar fixed bottom-0 left-[-300px] top-0 h-screen w-[300px] overflow-y-auto bg-gray-900 p-2 text-center shadow duration-1000 lg:left-0 dark:bg-gray-800 dark:shadow-slate-600">
        <div class="text-xl text-gray-100">
          <div class="mt-1 flex items-center rounded-md p-2.5">
            <i class="bi bi-app-indicator rounded-md bg-blue-600 px-2 py-1 dark:bg-slate-400"></i>
            <h1 class="ml-3 text-[15px] text-xl font-bold text-gray-200">{{ Auth::user()->nombres }}</h1>
            <i class="bi bi-x ml-20 cursor-pointer lg:hidden" onclick="Openbar()"></i>
          </div>
          <hr class="my-2 text-gray-600" />
      
          <div>
            <div class="mt-2 flex cursor-pointer items-center rounded-md p-2.5 px-4 duration-300 hover:bg-blue-600 dark:hover:bg-slate-400">
