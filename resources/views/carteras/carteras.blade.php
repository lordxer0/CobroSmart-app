  ...
  @section('content')
      <div class="mx-20 mt-24 grid">
          <div class="text-center">
            <h1 class="mb-8 text-center text-3xl font-bold">Carteras</h1>
          </div>
          <x-alert-success />
          <div class="text-end mb-6">
            <a href="{{route('crearCartera')}}" class="border border-sky-600 p-2 rounded-md text-sky-600 hover:bg-sky-600 hover:text-white">Crear cartera</a>
          </div>
                  ...
                  @foreach ($carteras as $cartera)
                    <tr class="border-b odd:bg-white even:bg-gray-50">
                      ...
                      <td class="flex gap-1 px-6 py-4">
                        ...
                        <a href="{{route('detalleCartera',['id' => $cartera->id])}}">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-6 w-6 text-black">
