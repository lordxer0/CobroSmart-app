...
<body>
    ...
    <div class="mx-20 mt-24 grid">          
        <div class="text-center">
            <h1 class="mb-8 text-center text-3xl font-bold">Detalle cartera</h1>
        </div>
        <span class="block">Nombre cartera: <strong></strong></span>
        <span class="block">Total cartera: <strong></strong></span>
        <div class="shadow-md sm:rounded-lg mt-8">
            <table class="text-left rtl:text-right" id="dataTable">
                ...
                <tbody>
                    <tr class="border-b odd:bg-white even:bg-gray-50">
                        <td class="whitespace-nowrap font-medium text-gray-900">1</td>
                        <td>Mona</td>
                        <td>$100.000</td>
                        <td>
    ...
    <div class="mx-20 bg-white mt-8 rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
